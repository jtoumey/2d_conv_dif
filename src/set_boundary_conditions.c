...
//      printf("\nWest boundary index: %d\n", ii);
      ...
      fvm_coeff[ii].a_E = phys_prop->Difx * phys_prop->area_east + max(0, -phys_prop->Fx * phys_prop->area_east); 
 ...
 //     printf("\nSouth bndry index: %d\n", ii);
      ...
      fvm_coeff[ii].a_N = phys_prop->Dify * phys_prop->area_north + max(0, -phys_prop->Fy * phys_prop->area_north); 
   ...
   {
  //    printf("\nNorth bndry index: %d\n", ii);
      fvm_coeff[ii].a_S = phys_prop->Dify * phys_prop->area_south + max(0, phys_prop->Fy * phys_prop->area_south);
   ...
   {
   //   printf("\nEast bndry index: %d\n", ii);
      fvm_coeff[ii].a_W = phys_prop->Difx * phys_prop->area_west + max(0, phys_prop->Fx * phys_prop->area_west);
